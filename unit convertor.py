...
for conversion_number, from_unit, to_unit in coversions_available:
...
conversion_number, from_unit, to_unit = coversions_available[conversion_index]
print()
